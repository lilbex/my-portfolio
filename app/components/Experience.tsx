...
const experiences: Experience[] = [
  {
    ...
    description: "Working on building scalable web applications and leading a team of junior developers.",
  ...
  },
  {
    ...
    description: "Developed several backend services and contributed to frontend development using React.",
    logo: "https://via.placeholder.com/100x100.png?text=Company+Logo", // Placeholder logo
    ...
    <section id="experience" className="py-20 bg-gray-100 text-center pt-28">
      ...
      <div ref={ref} className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {experiences.map((experience, index) => (
          ...
          >
            <img src={experience.logo} alt={`${experience.company} logo`} className="w-16 h-16 mr-4"/>
            <div>
              <h3 className="text-2xl font-bold mb-2">{experience.role}</h3>
              <a href={experience.link} target="_blank" rel="noopener noreferrer" className="text-gray-700 mb-1 hover:underline">{experience.company}</a>
