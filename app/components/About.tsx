...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-gray-100 text-center pt-28">
      <h2 className="text-4xl font-bold mb-4">About Me</h2>
      <p className="max-w-xl mx-auto px-4 sm:px-0">
        I am a highly skilled software engineer with extensive experience in
        back-end and front-end development. Proficient in Python, Django, Django
        Rest Framework, Node.js, Express, and a variety of databases including
        MySQL, PostgreSQL, and MongoDB. On the front end, I excel with React,
        Next.js, and Tailwind CSS, creating seamless and engaging user
        interfaces. I am also well-versed in cloud technologies, leveraging
        platforms such as AWS, Azure, and Google Cloud to build scalable and
        resilient applications. My passion lies in delivering elegant,
